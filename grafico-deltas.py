...
# Importar datos
data0 = np.loadtxt(pwd+'simulaciones-a-fijo/delta_44990_100_10E6_1_2024-05-07-01-33-47.txt') 
data1 = np.loadtxt(pwd+'simulaciones-a-fijo/delta_44990_1000_10E6_1_2024-05-07-03-07-08.txt')
data2 = np.loadtxt(pwd+'simulaciones-trabajofinal/09/delta_09_5000_10E6.txt')
